...
export function CrearEstado(){
    ...
    const { nombre, estado, usuario } = estadoEquipo;
    ...
    const handleSubmit = async e => {
        ...
        clearDataForm();
        try {
            const response = await API.createEstado(data);
            Swal.fire({
                title: 'Tipo creado',
    ...
    return (
        <>
            ...
            <Link to='/estados' className="btn position-absolute bottom-0 end-0 fs-1 text-black mx-5 my-5" > <TiArrowBack /> </Link>
        </>
    )
}